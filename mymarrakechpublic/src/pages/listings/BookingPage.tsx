    ...
    <div className="max-w-7xl mx-auto p-4 md:p-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2">
          ...
          { activity.description && <section aria-labelledby="description-heading" className="mb-8">
          ...
          { activity.schedules.length > 0 && <section aria-labelledby="schedules-heading" className="mb-8">
          ...
          {activity.payment_methods && <section aria-labelledby="payment-heading" className="mb-8">
          ...
          { activity.localisation && <section aria-labelledby="location-heading" className="mb-8">
