...
// export default function Listing({activity,slug}: {activity:ActivityType,slug:string}) {
//     return (
//       <a href={`/${slug}/${activity.id}`} className="bg-white rounded-sm overflow-hidden 
//       border border-gray-100 hover:shadow-xl transition-shadow">
//         <div className="relative min-h-48">
//           <img src={activity.image || "/placeholder.svg"} alt={activity.title} className="object-cover" />
//         </div>
//         <div className="p-4 pb-2">
//           <div className="flex justify-between items-start mb-2">
//             <div>
//               {
//                 activity?.category_title && <div className="text-sm mb-1 bg-[#cb947e] w-fit px-2 py-1 rounded-md text-white font-medium">
//                   {activity?.category_title}
//                 </div>
//                 }
//               <h3 className="font-medium text-gray-900 text-lg tracking-[-0.8px]">{activity.title}</h3>
//             </div>
//             {/* <div className="bg-white px-2 py-1 rounded-md shadow-sm text-amber-600 font-medium">{rating}</div> */}
//           </div>
  
//           {activity.description && (
//             <div className="flex items-start gap-2 text-sm text-gray-600 mb-2">
//               <MapPin className="w-4 h-4" />
//               <span>{activity.description.substring(0,50)}...</span>
//             </div>
//           )}
...
//             {/* {activity.transportIncluded && <span className="bg-[#cb947e] text-white text-xs px-2 py-1 rounded">Transport inclus</span>} */}
//             <Price pricesProp={activity?.prices} />
//           </div>
//         </div>
//       </a>
//     )
