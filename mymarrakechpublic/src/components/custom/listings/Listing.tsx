...
export default function Listing({
    ...
    const { id, title, image, description, category_title, prices } = activity;
    ...
    return (
        <a
            href={`/${slug}/${id}/${resourceType}`}
            className={`bg-white rounded-sm overflow-hidden border border-gray-100 hover:shadow-xl transition-shadow ${className}`}
